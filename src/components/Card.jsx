...
function Card({name,image,id,price,type}) {
  ...
  return (
    <div className="w-[300px] h-[400px] bg-white p-3 rounded-lg flex flex-col gap-3 shadow-lg hover:border-2 border-green-300">
      ...
      <div>
        <button className="w-full p-3 bg-green-300 rounded-lg text-grey-700 hover:bg-green-400 transition-all duration-200" onClick={()=>{dispactch(Additem({id:id ,name:name ,price:price,image:image,qty:1}))
